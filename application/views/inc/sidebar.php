		...
		<div class="scroll-sidebar">
			<nav class="sidebar-nav">
				<ul id="sidebarnav">
					...
					<li> <a href="<?php echo base_url();?>" ><span> <i class="fas fa-home"></i> </span><span class="hide-menu">Home</span></a></li>
					<li> <a href="<?php echo base_url();?>student/addstudent" ><span> <i class="fas fa-users"></i> </span><span class="hide-menu">Add Student</span></a></li>
					
					<li> <a href="<?php echo base_url();?>student/studentlist" ><span> <i class="fas fa-users"></i> </span><span class="hide-menu">Student List</span></a></li>
